...
def qr_dqn(seed=1, eps_test=0.05,
           eps_train=0.1, buffer_size=20000, lr=1e-3, gamma=0.9, num_quantiles=200,
           n_step=3, target_update_freq=320, epoch=10, step_per_epoch=10000,
           step_per_collect=10, update_per_step=0.1, batch_size=64,
           hidden_sizes=[128, 128, 128, 128], training_num=10, test_num=100,
    ...
    log_path = os.path.join(logdir, task, "qrdqn")
